		...
		$.messager.confirm("确定","确定要删除吗？",function(r){
			if(r){
				...
				if(row.text==""){
					...
					$.post('selectRolesModulesYang',{
						Modules_ID:id
						},function(res){
							if(res>0){
								$.messager.confirm('确认','此角色以分配用户，是否确认删除？',function(r){
									if (r){
										$.ajax({
											type:"post",//提交方式
											url:"deleteRolesAndModulesYang",//提交路径
											datatype:"json",//格式
											data:{//传递的参数
												Modules_ID:id
...
<body>
	<div class="" data-options="title:'模块管理'"
	...
	<!-- 新增模块 -->
	<div id="addModalWindow" class="easyui-window"
		style="width: 500px; height: 300px; padding: 10px;"
		data-options="modal:true,closed:true,title:'新增模块信息'">
			...
			<table cellpadding="5">
				...
				<tr>
					...
					<td><input type="text" class="easyui-textbox"
						name="ModalWeight" id="ModalWeight" value="" required="required" /></td>
				</tr>
				<tr>
					<td>URL：</td>
					<td><input type="text" class="easyui-textbox" name="ModalURL"
						id="ModalURL" value="" required="required" /></td>
				</tr>
				<tr>
					<td>模块名称：</td>
					<td><input type="text" class="easyui-textbox" name="ModalName"
						id="ModalName" value="" required="required" /></td>
				</tr>
			</table>
		</form>
		<div style="text-align: center; padding: 20px">
			<a href="javascript:void(0)" class="easyui-linkbutton" type="button"
				onclick="submitModal()">保存</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <a
				href="javascript:void(0)" class="easyui-linkbutton"
				onclick="clearModal()">取消</a>
		</div>
	</div>
	<!--修改  -->
	<div id="updateModalWindow" class="easyui-window"
		style="width: 500px; height: 300px; padding: 10px;"
		data-options="modal:true,closed:true,title:'修改模块信息'">
		<form id="updateModalForm">
			<table cellpadding="5">
				<input type="hidden" id="modules_Id" />
				<tr>
					<td>权重：</td>
					<td><input type="text" id="modules_weight" value=""
						required="required" /></td>
				</tr>
				<tr>
					<td>URL：</td>
					<td><input type="text" id="modules_Path" value=""
						required="required" /></td>
				</tr>
				<tr>
					<td>模块名称：</td>
					<td><input type="text" id="modules_Name" value=""
						required="required" /></td>
				</tr>
			</table>
		</form>
		<div style="text-align: center; padding: 20px">
			<a href="javascript:void(0)" class="easyui-linkbutton" type="button"
				onclick="submitModalFrom()">保存</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <a
				href="javascript:void(0)" class="easyui-linkbutton"
				onclick="clearModalFrom()">取消</a>
		</div>
	</div>
