   ...
   <table class="easyui-datagrid" id="tab" data-options="fitColumns:true,singleSelect:true,toolbar:'#r'">   
    <thead>   
        <tr>   
            ...
            <th data-options="field:'staffCaozuoyonghu',formatter:staffCaozuoyonghu">操作用户</th>         
        </tr>   
    </thead>   
</table> 
 <div id="r">
...
<div id="win" class="easyui-window" title="添加员工" style="width:400px;height:300px"   
        ...
        <table cellpadding=7>
          ...
          <tr>
             <td></td>
             <td>
               <a onclick="staffSave()" href="#" class="easyui-linkbutton" data-options="iconCls:'icon-search'">提交</a> 
               <a onclick="staffNo()" href="#" class="easyui-linkbutton" data-options="iconCls:'icon-add'">取消</a>
             </td>
          </tr>
        </table>  
...
<div id="updateRoles-window" class="easyui-window" data-options="modal:true,closed:true,title:'修改角色'" style="width: 500px;height: 300px;padding: 20px;">
	<form id="updateRolesForm" style="padding: 20px;">
		<input type="hidden" name="staff_ID" id="update-staff_ID" />
		用户名:<input type="text" class="easyui-textbox" name="staff_Name" id="update-staff_Name" value="" required="required"/>
	</form>
...
<div id="congzhimima-window" class="easyui-window" data-options="modal:true,closed:true,title:'修改角色'" style="width: 500px;height: 300px;padding: 20px;">
	<form id="congzhimima" style="padding: 20px;">
		<input type="hidden" name="staff_ID" id="chong-staff_ID" />
		旧密码:<input type="text" class="easyui-textbox" id="chong-password" value="" required="required"/>
		新密码:<input type="text" class="easyui-textbox" id="chong-password" value="" required="required"/>
	</form>
	<div style="text-align:center;padding:20px">
         <a href="javascript:void(0)" class="easyui-linkbutton" type="button" onclick="submitchongFrom()">保存</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
         <a href="javascript:void(0)" class="easyui-linkbutton" onclick="clearJsFrom()">取消</a>        
     </div>
 </div>
...
<div id="roles-window" class="easyui-window" data-options="modal:true,closed:true,iconCls:'icon-save'" style="width: 700px;height:500px">
	<table>
		<tr>
			<td>
				<table class="easyui-datagrid" id="syyh" title="用户列表" data-options="singleSelect:true,method:'post'" style="width: 250px;">
					<thead>
						<tr>
		...
		<td>
			<a href="javascript:void(0)" class="easyui-linkbutton" type="button" onclick="tianjia()">>></a><br /><br />
			<a href="javascript:void(0)" class="easyui-linkbutton" onclick="yichu()">
				<<</a>
		</td>
			<td>
				<table class="easyui-datagrid" id="dqyh" title="用户列表" data-options="singleSelect:true,method:'post'" style="width: 250px;height: 250px;">
					<thead>
						<tr>
							<th data-options="field:'rolesId',width:70"></th>
							<th data-options="field:'rolesName',width:100">名称</th>
