...
<body>
	<center style="margin-top: 150px;">
		<div id="" class="easyui-panel" data-options="title:'登录页面'"
			...
			<form id="fmLogin" method="post">
				...
				<table style="padding: 30px;" cellpadding="10">
					<tr>
						<td>用户名：</td>
						<td><input name="Staff_Name" id="Staff_Name"
					...
					<tr style="padding: 20px;">
						<td>验证码：</td>
						<td><input name="kaptcha" type="text" id="kaptcha"
							maxlength="4" class="easyui-textbox" required="required"
							style="width: 60px" /> <img src="KaptchaServlet"
							id="kaptchaImage" style="height: 30px;" /> <a
					...
					<tr style="padding: 20px;">
						...
						<td>
							...
							<a id="btn" href="javascript:denglu()" class="easyui-linkbutton"
