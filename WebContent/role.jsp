...
<body>
	...
	<div id="Roles-Toolbar">
		<form class="easyui-form" id="Roles-form">
			<label for="name">角色名称：</label> <input class="easyui-textbox"
				type="text" id="rolesName" name="name" /> <a id="btn"
				href="javascript:sousuo()" class="easyui-linkbutton"
				data-options="iconCls:'icon-search'">搜索</a> <a id="btn"
				href="javascript:Rolesadd()" class="easyui-linkbutton"
				data-options="iconCls:'icon-add'">添加</a>
		</form>
	</div>
	<!--添加 弹出框 -->

	<div id="Roles-add" class="easyui-dialog" title="角色添加"
		...
		<form id="" class="easyui-form">
			<table>
				<div>
					<label for="name">角色名称：</label> <input class="easyui-textbox"
						type="text" id="inset-rolesNmae" name="name"
						data-options="required:true" />
				</div>
				<div>
					<a id="btn" href="javascript:RolesInsetadd()"
	...
	<div id="updateRoles-window" class="easyui-window"
		...
		<form id="updateRolesForm" style="padding: 20px;">
			<input type="hidden" name="rolesId" id="update-RolesId" /> 角色名称:<input
				type="text" class="easyui-textbox" name="rolesName"
				id="update-RolesName" value="" required="required" />
		</form>
	...
	<!-- 设置权限 -->
	<div id="shezhi-window" class="easyui-window"
		data-options="modal:true,closed:true"
		style="width: 500px; height: 600px;">
		<ul id="shezhiTree" class="easyui-tree"></ul>
		<a href="javascript:void(0)" class="easyui-linkbutton" type="button"
			onclick="baocunTree()">保存</a>
	</div>
</body>
</html>